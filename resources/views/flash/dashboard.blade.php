            ...
            <div class="d-flex flex-column gap-3">
                                ...
                                <div class="card mb-xxl-0 iq-purchase" data-iq-gsap="onStart" data-iq-position-y="50"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                            ...
                                            <a href="{{ route('flash.trucks.index') }}">
                                ...
                                <div class="card mb-xxl-0 iq-purchase" data-iq-gsap="onStart" data-iq-position-y="150"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                            ...
                                            <a href="{{ route('flash.drivers.index') }}">
                                ...
                                <div class="card iq-purchase" data-iq-gsap="onStart" data-iq-position-y="250"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                            ...
                                            <a href="{{ route('flash.destinations.index') }}">
                                ...
                                <div class="card iq-purchase" data-iq-gsap="onStart" data-iq-position-y="350"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                            ...
                                            <a href="{{ route('flash.trips.index') }}">
                ...
                <div class="card" data-iq-gsap="onStart" data-iq-position-y="70" data-iq-rotate="0"
                    ...
                    <div class="card-header justify-content-between d-flex align-items-center">
                        ...
                        <a href="{{ route('flash.trips.index') }}" class="btn btn-primary btn-sm">View All</a>
                    </div>
                ...
                <div class="card" data-iq-gsap="onStart" data-iq-position-y="70" data-iq-rotate="0"
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('flash.destinations.index') }}" class="btn btn-primary btn-sm">View all</a>
                    </div>
                                ...
                                <div class="col">
                                    <div class="card border h-100">
                                        <div class="card-body">
                                            ...
                                            <h6 class="card-title mb-2">{{ $destination->area ?? 'N/A' }}</h6>
                                            <p class="mb-1 small"><strong>Code:</strong>
                                                {{ $destination->hub_code ?? '—' }}</p>
    ...
    ">
                ...
                <div class="card" data-iq-gsap="onStart" data-iq-position-y="70" data-iq-rotate="0"
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('flash.trips.history') }}" class="btn btn-primary btn-sm"> View All </a>
                    </div>
                        ...
                        @forelse($recentTrips as $trip)
                            <div
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <span
                                        class="text-muted small">{{ $trip->destination?->area ?? 'No destination' }}</span>
                                </div>
