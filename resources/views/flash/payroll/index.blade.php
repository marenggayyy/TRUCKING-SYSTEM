        ...
        <div class="ui-hero p-3 p-lg-4 mb-3 mb-lg-4">
            <div
                ...
                <div class="d-flex gap-2">
                    ...
                    <a class="btn btn-outline-secondary w-full w-sm-auto" href="{{ route('flash.payroll.dashboard') }}">
                        ← Dashboard
                    </a>

                    <a class="btn btn-outline-secondary w-full w-sm-auto" href="{{ route('flash.payroll.history') }}">
                        → History
                    </a>
        ...
        <div class="card ui-card border-0 shadow-sm">
            <div class="card-body">
                ...
                <ul class="nav nav-pills d-flex flex-column flex-md-row gap-2 mb-3 align-items-start align-items-md-center">
                    ...
                    <form method="POST" action="{{ route('flash.payroll.finalize') }}"
    ...
    <div class="modal fade" id="payModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('flash.payroll.pay') }}">
                    @csrf
