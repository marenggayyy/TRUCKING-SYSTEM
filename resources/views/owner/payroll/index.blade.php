        ...
        <div class="card ui-card border-0 shadow-sm">
            <div class="card-body">
                ...
                <ul class="nav nav-pills d-flex flex-column flex-md-row gap-2 mb-3 align-items-start align-items-md-center">
                    ...
                    <form method="POST" action="{{ route('owner.payroll.finalize') }}" class="d-flex w-full w-md-auto justify-content-start mt-2 mt-md-0">
                        @csrf
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="tabDrivers">
                        @forelse($driversPayroll as $p)
                                        ...
                                        <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center gap-2 w-100 pay-status-row">
                                            ...
                                            @if ($status !== 'PAID')
                                                <button class="btn btn-sm btn-success pay-btn w-100 w-sm-auto ms-sm-auto" data-bs-toggle="modal"
                                                    data-bs-target="#payModal" data-person-id="{{ $p['person_id'] }}"
                                                    data-person-type="driver" data-name="{{ $p['name'] }}"
                                    ...
                                    <div class="overflow-x-auto">
                                        <table class="table table-bordered payroll-table mb-0 w-full">
                                            ...
                                            <tbody>
                                                @foreach ($p['rows'] as $r)
                                                    <tr>
                                                        <td class="text-center" data-label="Date">{{ $r['date'] }}</td>
                                                        <td class="break-words" data-label="Destination">{{ $r['location'] }}</td>

                                                        <td class="text-end whitespace-nowrap" data-label="Rate">{{ number_format($r['rate'], 2) }}</td>

                                                        <td class="text-end whitespace-nowrap" data-label="Amount">{{ number_format($r['amount'], 2) }}</td>

                                                        <td class="text-end whitespace-nowrap" data-label="Allowance">{{ number_format($r['allowance'], 2) }}</td>
                            ...
                            {{-- Pay Modal --}}
                            <div class="modal fade" id="payDriver{{ $p['person_id'] }}" tabindex="-1">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form method="POST" action="{{ route('owner.payroll.pay') }}">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="hidden" name="total_trips" value="{{ count($p['rows']) }}">
                                                <input type="hidden" name="amount" value="{{ $p['payroll_total'] }}">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <input class="form-control" value="{{ count($p['rows']) }}" readonly>
                                                </div>

                                                <div class="mb-2">
                                                    <label class="form-label">Total Amount</label>
                                                    <input class="form-control"
                                                        value="₱ {{ number_format($p['payroll_total'], 2) }}" readonly>
                                                </div>
                    ...
                    <div class="tab-pane fade" id="tabHelpers">
                        @forelse($helpersPayroll as $p)
                                    ...
                                    <div class="p-3 border-bottom d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center gap-2 w-100 pay-status-row">
                                            ...
                                            @if ($status !== 'PAID')
                                                <button class="btn btn-sm btn-success pay-btn w-100 w-sm-auto ms-sm-auto" data-bs-toggle="modal"
                                                    data-bs-target="#payModal" data-person-id="{{ $p['person_id'] }}"
                                                    data-person-type="helper" data-name="{{ $p['name'] }}"
                                                    data-trips="{{ count($p['rows']) }}"
                                                    data-amount="{{ $p['payroll_total'] }}">
                                                    Pay
                                                </button>
                            ...
                            {{-- Pay Modal --}}
                            <div class="modal fade" id="payHelper{{ $p['person_id'] }}" tabindex="-1">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
