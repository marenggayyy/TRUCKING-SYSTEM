                                ...
                                <div class="card border mb-3">
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="p-3 border-bottom d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2">
                                            <div>
                                                <div class="fw-bold text-info">{{ $p['name'] ?? 'Unknown Driver' }} <span
                                                ...
                                                <tbody>
                                                    ...
                                                    @forelse($p['rows'] as $r)
                                                        <tr>
                                                            ...
                                                            <td class="text-end whitespace-nowrap" data-label="Allowance">{{ number_format($r['allowance'], 2) }}
                                                            </td>
                                ...
                                <div class="card border mb-3">
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="p-3 border-bottom d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2">
                                            ...
                                            <div class="fw-bold text-info">{{ $p['name'] ?? 'Unknown Helper' }} <span
