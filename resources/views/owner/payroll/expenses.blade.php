                                ...
                                @foreach ($expenses as $i => $row)
                                    ...
                                    <tr style="display:{{ $i < 10 ? 'table-row' : 'none' }};">
                                        ...
                                        <td class="text-center d-flex justify-content-center gap-2">
                                            ...
                                            <!-- VIEW IMAGE -->
                                            <button class="btn btn-sm btn-outline-secondary view-receipt-btn"
                    ...
                    <div class="modal fade" id="viewReceiptModal" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-body text-center">
                                ...
                                <div id="noReceiptText" class="text-muted fw-semibold">
                                    No receipt uploaded
                                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="editCreditForm">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Amount (PHP)</label>
                                <input type="number" step="0.01" id="editCreditAmount" class="form-control"
                                    required>
                            </div>
                    ...
                    <div class="modal-body">
                        <form id="editExpenseForm">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-6">
                                    <label class="form-label">Amount (PHP)</label>
                                    <input type="number" step="0.01" name="debit" id="editDebit"
                                        class="form-control" required>
                                </div>
                                <div class="col-6">
                ...
                plateSelect.addEventListener('change', function() {
                    ...
                    if (plate) {
                        fetch(`${lastOdoUrl}/${plate}`)
                            .then(res => res.json())
                            .then(data => {
                                document.querySelector('#addExpenseModal input[name="start_odometer"]')
                                    .value =
                                    data.odometer ?? '';
                            });
                    }

                    // UPDATE CONTACT IF LOAD
