            ...
            <div class="card-header bg-transparent border-0 pb-0">
                ...
                <div
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <a href="{{ route('owner.payroll.billing') }}" class="btn btn-outline-secondary btn-sm ui-pill-btn">
                            <i class="bi bi-receipt me-1"></i> Billing
                        </a>

                        <a href="{{ route('owner.trips.index') }}" class="btn btn-outline-secondary btn-sm ui-pill-btn">
                ...
                <div
                    ...
                    <form method="GET" action="{{ route('owner.trips.history') }}"
                        ...
                        @if (request('q'))
                            <a href="{{ route('owner.trips.history', request()->except('q', 'page')) }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="person-stack">
                                                ...
                                                {{-- HELPERS --}}
                                                @foreach ($helperNames as $i => $helper)
                                                    <div class="person-avatar color-{{ ($i % 7) + 2 }}"
                                                        data-name="{{ $helper }} (Helper)">

                                                        {{ strtoupper(substr($helper, 0, 1)) }}
