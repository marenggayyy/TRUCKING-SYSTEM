            ...
            <div class="card-header bg-transparent border-0 pb-0">
                ...
                <div
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <a href="<?php echo e(route('flash.payroll.billing')); ?>" class="btn btn-outline-secondary btn-sm ui-pill-btn">
                            <i class="bi bi-receipt me-1"></i> Billing
                        </a>

                        <a href="<?php echo e(route('flash.trips.index')); ?>" class="btn btn-outline-secondary btn-sm ui-pill-btn">
                ...
                <div
                    ...
                    <form method="GET" action="<?php echo e(route('flash.trips.history')); ?>"
                        ...
                        <?php if(request('q')): ?>
                            <a href="<?php echo e(route('flash.trips.history', request()->except('q', 'page'))); ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn p-0 billing-toggle"
                                                data-url="<?php echo e(route('flash.trips.updateBilling', $t->id)); ?>">
                                        ...
                                        <td>
                                           <?php echo e($t->check_release_date ?? '-'); ?>
                ...
                : 'bg-secondary')); ?>">
                                        ...
                                        <td class="text-center d-flex justify-content-center gap-1">
                                            ...
                                            <?php if(in_array(auth()->user()->role, ['owner', 'it'])): ?>
                                                <form action="<?php echo e(route('flash.trips.destroy', $t->id)); ?>" method="POST"
...
<?php echo $__env->make('layouts.flash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HF-PC\Downloads\last zip\laravel_app\resources\views/flash/trips/history.blade.php ENDPATH**/ ?>