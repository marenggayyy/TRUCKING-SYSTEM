        ...
        <div class="card ui-card border-0 shadow-sm">
            <div class="card-body">
                ...
                <ul class="nav nav-pills d-flex flex-column flex-md-row gap-2 mb-3 align-items-start align-items-md-center">
                    ...
                    <form method="POST" action="<?php echo e(route('owner.payroll.finalize')); ?>" class="d-flex w-full w-md-auto justify-content-start mt-2 mt-md-0">
                        <?php echo csrf_field(); ?>
                ...
                <div class="tab-content">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $driversPayroll; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <div class="card border-0 shadow-sm mb-3">
                                <div class="card-body p-0">
                                    ...
                                    <div class="p-3 border-bottom d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2">
                                        <div>
                                            <div class="fw-bold text-info"><?php echo e($p['name']); ?> <span
                                                    class="text-muted small ms-1">Driver</span></div>
                                        </div>

                                        <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center gap-2 w-100 pay-status-row">

                                            <span class="badge bg-<?php echo e($badge); ?>"><?php echo e($status); ?></span>

                                            <?php if($status !== 'PAID'): ?>
                                                <button class="btn btn-sm btn-success pay-btn w-100 w-sm-auto ms-sm-auto" data-bs-toggle="modal"
                                                    data-bs-target="#payModal" data-person-id="<?php echo e($p['person_id']); ?>"
                                                    data-person-type="driver" data-name="<?php echo e($p['name']); ?>"
                                        ...
                                        <table class="table table-bordered payroll-table mb-0 w-full">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $p['rows']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td class="text-center" data-label="Date"><?php echo e($r['date']); ?></td>
                                                        <td class="break-words" data-label="Destination"><?php echo e($r['location']); ?></td>

                                                        <td class="text-end whitespace-nowrap" data-label="Rate"><?php echo e(number_format($r['rate'], 2)); ?></td>

                                                        <td class="text-end whitespace-nowrap" data-label="Amount"><?php echo e(number_format($r['amount'], 2)); ?></td>

                                                        <td class="text-end whitespace-nowrap" data-label="Allowance"><?php echo e(number_format($r['allowance'], 2)); ?></td>
                            ...
                            <div class="modal fade" id="payDriver<?php echo e($p['person_id']); ?>" tabindex="-1">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form method="POST" action="<?php echo e(route('owner.payroll.pay')); ?>">
                                            ...
                                            <div class="modal-header">
                                                <h6 class="modal-title">Pay Driver</h6>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="hidden" name="person_id" value="<?php echo e($p['person_id']); ?>">
                                                <input type="hidden" name="total_trips" value="<?php echo e(count($p['rows'])); ?>">
                                                <input type="hidden" name="amount" value="<?php echo e($p['payroll_total']); ?>">
                                                <input type="hidden" name="week_start"
                                                    value="<?php echo e($weekStart->toDateString()); ?>">
                                                <input type="hidden" name="week_end"
                                                    value="<?php echo e($weekEnd->toDateString()); ?>">

                                                <div class="mb-2">
                                                    <label class="form-label">Driver Name</label>
                                                    <input class="form-control" value="<?php echo e($p['name']); ?>" readonly>
                                                </div>

                                                <div class="mb-2">
                                                    <label class="form-label">Total Trips</label>
                                                    <input class="form-control" value="<?php echo e(count($p['rows'])); ?>" readonly>
                                                </div>

                                                <div class="mb-2">
                                                    <label class="form-label">Total Amount</label>
                                                    <input class="form-control"
                                                        value="₱ <?php echo e(number_format($p['payroll_total'], 2)); ?>" readonly>
                                                </div>

                                                <div class="mb-2">
                                                    <label class="form-label">Balance Advance</label>
                                                    <input type="number" step="0.01" name="balance_advance"
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <input class="form-control" value="<?php echo e(auth()->user()->name); ?>"
                                                        readonly>
                                                </div>
                    ...
                    <div class="tab-pane fade" id="tabHelpers">
                        <?php $__empty_1 = true; $__currentLoopData = $helpersPayroll; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    <div class="p-3 border-bottom d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center gap-2 w-100 pay-status-row">
                                            ...
                                            <?php if($status !== 'PAID'): ?>
                                                <button class="btn btn-sm btn-success pay-btn w-100 w-sm-auto ms-sm-auto" data-bs-toggle="modal"
                                                    data-bs-target="#payModal" data-person-id="<?php echo e($p['person_id']); ?>"
                                                    data-person-type="helper" data-name="<?php echo e($p['name']); ?>"
                                                    data-trips="<?php echo e(count($p['rows'])); ?>"
                                                    data-amount="<?php echo e($p['payroll_total']); ?>">
                                                    Pay
                                                </button>
                            ...
                            <div class="modal fade" id="payHelper<?php echo e($p['person_id']); ?>" tabindex="-1">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form method="POST" action="<?php echo e(route('owner.payroll.pay')); ?>">
                                            ...
                                            <div class="modal-header">
                                                <h6 class="modal-title">Pay Helper</h6>
...
<?php echo $__env->make('layouts.owner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u649672793/domains/gray-spoonbill-292506.hostingersite.com/laravel_app/resources/views/owner/payroll/index.blade.php ENDPATH**/ ?>