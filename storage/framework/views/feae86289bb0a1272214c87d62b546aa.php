        ...
        <div class="ui-hero p-3 p-lg-4 mb-3 mb-lg-4">
            <div
                ...
                <div class="d-flex gap-2">
                    ...
                    <a class="btn btn-outline-secondary w-full w-sm-auto" href="<?php echo e(route('flash.payroll.dashboard')); ?>">
                        ← Dashboard
                    </a>

                    <a class="btn btn-outline-secondary w-full w-sm-auto" href="<?php echo e(route('flash.payroll.history')); ?>">
                        → History
                    </a>
        ...
        <div class="card ui-card border-0 shadow-sm">
            <div class="card-body">
                ...
                <ul class="nav nav-pills d-flex flex-column flex-md-row gap-2 mb-3 align-items-start align-items-md-center">
                    ...
                    <form method="POST" action="<?php echo e(route('flash.payroll.finalize')); ?>"
                                        ...
                                        <div class="d-flex justify-content-end align-items-center gap-2">
                                            ...
                                            <?php if($status !== 'PAID'): ?>
                                                <button type="button" class="btn btn-sm btn-success pay-btn"
                                                    ...
                                                    data-name="<?php echo e($p['name']); ?>" data-trips="<?php echo e(count($p['rows'])); ?>"
                                                ...
                                                <?php $__currentLoopData = $p['rows']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td class="break-words" data-label="Destination">
                                                            <?php echo e($r['destination']); ?></td>

                                                        <td><?php echo e($r['trip_number']); ?></td>
    ...
    <div class="modal fade" id="payModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form method="POST" action="<?php echo e(route('flash.payroll.pay')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.flash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HF-PC\Downloads\last zip\laravel_app\resources\views/flash/payroll/index.blade.php ENDPATH**/ ?>