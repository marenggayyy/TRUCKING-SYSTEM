    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('flash.dashboard') ? 'active' : ''); ?>"
                        href="<?php echo e(route('flash.dashboard')); ?>">
                        <i class="icon">
                ...
                <?php if(hasRole(['owner', 'it', 'admin', 'secretary'])): ?>
                    <li class="nav-item <?php echo e($operationsOpen ? 'active' : ''); ?>">
                        <a class="nav-link <?php echo e($operationsOpen ? 'active' : 'collapsed'); ?>" data-bs-toggle="collapse"
                        ...
                        <ul class="sub-nav collapse <?php echo e($operationsOpen ? 'show' : ''); ?>" id="sidebar-operations">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->routeIs($prefix . '.trips.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route($prefix . '.trips.index')); ?>">
                                    <i class="icon">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->routeIs($prefix . '.trucks.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route($prefix . '.trucks.index')); ?>">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <circle cx="12" cy="12" r="8" />
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->routeIs($prefix . '.drivers.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route($prefix . '.drivers.index')); ?>">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <circle cx="12" cy="12" r="8" />
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->routeIs($prefix . '.destinations.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route($prefix . '.destinations.index')); ?>">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <circle cx="12" cy="12" r="8" />
                ...
                <?php if(hasRole(['owner', 'it', 'admin', 'secretary'])): ?>
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-finance" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->routeIs('flash.payroll.billing') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('flash.payroll.billing')); ?>">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                            ...
                            <?php if(hasRole(['owner', 'it'])): ?>
                                <li class="nav-item">
                                    <a class="nav-link <?php echo e(request()->routeIs('flash.payroll.dashboard') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('flash.payroll.dashboard')); ?>">
                                        <i class="icon">
...
<?php /**PATH C:\Users\HF-PC\Downloads\last zip\laravel_app\resources\views/partials/sidebar-flash.blade.php ENDPATH**/ ?>