...
<?php $__env->startSection('title', 'Trips / Dispatch'); ?>
                ...
                <div class="card ui-available-card border-bottom border-4 border-0 border-warning"
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex align-items-center gap-3 flex-shrink-0">
                                <div class="ui-available-number text-warning"><?php echo e($availableHelpers->count()); ?></div>
                ...
                <div class="collapse mt-0 ui-available-dropdown" id="availHelpersList">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body py-2">
                            ...
                            <?php if($availableHelpers->count() > 5): ?>
                                <div class="d-flex justify-content-end align-items-center gap-2 mt-2 ui-list-controls"
        ...
        <div class="modal fade" id="newTripModal" tabindex="-1" aria-labelledby="newTripModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content border-0 shadow">
                    <form method="POST" action="<?php echo e(route('owner.trips.store')); ?>">
                        <?php echo csrf_field(); ?>
                                        ...
                                        <select name="destination_id" id="destinationSelect"
                                            ...
                                            <?php $__currentLoopData = $destinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($d->id); ?>" data-truck="<?php echo e($d->truck_type); ?>"
                                                    class="option-<?php echo e(strtolower($d->truck_type)); ?>"
                                                    <?php echo e(old('destination_id') == $d->id ? 'selected' : ''); ?>>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="helper_1_id" id="helper1" class="form-select">
                                            ...
                                            <?php $__currentLoopData = $helpers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($h->id); ?>"
                                                    <?php echo e(old('helper_1_id') == $h->id ? 'selected' : ''); ?>>
                                                    <?php echo e($h->name); ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="helper_2_id" id="helper2" class="form-select">
                                            ...
                                            <?php $__currentLoopData = $helpers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($h->id); ?>"
                                                    <?php echo e(old('helper_2_id') == $h->id ? 'selected' : ''); ?>>
                                                    <?php echo e($h->name); ?>
            ...
            <div class="modal fade" id="dispatchModal-<?php echo e($t->id); ?>" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form method="POST" action="<?php echo e(route('owner.trips.dispatch', $t->id)); ?>">
                            <?php echo csrf_field(); ?>
                ...
                <div class="modal fade" id="editTripModal-<?php echo e($t->id); ?>" tabindex="-1">
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content border-0 shadow">
                            ...
                            <form method="POST" action="<?php echo e(route('owner.trips.update', $t->id)); ?>">
                                <?php echo csrf_field(); ?>
                                        ...
                                        <div class="row g-3">
                                                ...
                                                <select name="truck_id" class="form-select" required>
                                                    ...
                                                    <?php $__currentLoopData = $trucks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $truck): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($truck->id); ?>"
                                                            data-truck="<?php echo e($truck->truck_type); ?>"
                                                            <?php echo e($truck->id == $t->truck_id ? 'selected' : ''); ?>>

                                                            <?php echo e($truck->plate_number); ?>

                                                            <?php echo e($truck->truck_type ? '(' . $truck->truck_type . ')' : ''); ?>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="helper_1_id" class="form-select">
                                                    ...
                                                    <?php $__currentLoopData = $helpers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($h->id); ?>"
                                                            <?php echo e(optional($t->helpers->get(0))->id == $h->id ? 'selected' : ''); ?>>
                                                            <?php echo e($h->name); ?>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="helper_2_id" class="form-select">
                                                    ...
                                                    <?php $__currentLoopData = $helpers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($h->id); ?>"
                                                            <?php echo e(optional($t->helpers->get(1))->id == $h->id ? 'selected' : ''); ?>>
                                                            <?php echo e($h->name); ?>
        ...
        <div class="card ui-card border-0 mt-3">
            <div class="card-header bg-transparent border-0 pb-0">
                ...
                <div
                    ...
                    <a href="<?php echo e(route('owner.trips.history')); ?>" class="btn btn-outline-secondary btn-sm ui-pill-btn">
                ...
                <div
                    ...
                    <form method="GET" action="<?php echo e(route('owner.trips.index')); ?>"
                        ...
                        <?php if(request('q')): ?>
                            <a href="<?php echo e(route('owner.trips.index', request()->except('q', 'page'))); ?>"
                                    ...
                                    <div class="small">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            ...
                                            <div class="person-stack">
                                                ...
                                                <?php $__currentLoopData = $t->helpers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="person-avatar" data-name="<?php echo e($h->name); ?>"
                                                        data-initial="<?php echo e(strtoupper(substr($h->name, 0, 1))); ?>">

                                                        <?php echo e(strtoupper(substr($h->name, 0, 1))); ?>
                                    ...
                                    <div class="trip-actions mt-auto">
                                        ...
                                        <div class="trip-icons">
                                            ...
                                            <?php if($t->status == 'Draft'): ?>
                                                ...
                                                <form method="POST" action="<?php echo e(route('owner.trips.assign', $t->id)); ?>"
                                                    class="trip-dispatch">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.owner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u649672793/domains/gray-spoonbill-292506.hostingersite.com/laravel_app/resources/views/owner/trips/index.blade.php ENDPATH**/ ?>