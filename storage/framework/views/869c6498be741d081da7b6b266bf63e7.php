            ...
            <div class="card-header bg-transparent border-0 pb-0">
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                    ...
                    <div class="d-flex align-items-center gap-2 flex-wrap ms-auto">
                        ...
                        <a href="<?php echo e(route('flash.trips.history')); ?>" class="btn btn-outline-dark ui-btn-equal">
                        ...
                        <form class="billing-filter">
                            ...
                            <div class="d-flex align-items-center gap-2 flex-wrap flex-md-nowrap">
                                ...
                                <a href="<?php echo e(route('flash.payroll.billing')); ?>" class="btn btn-light filter-btn-clear">
                                    Clear
                                </a>
            ...
            <div class="modal fade" id="billTripModal-<?php echo e($t->id); ?>" tabindex="-1">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content border-0 shadow">
                        ...
                        <form method="POST" action="<?php echo e(route('flash.trips.complete', $t->id)); ?>">
                            <?php echo csrf_field(); ?>
        ...
        <div class="modal fade" id="editBillingModal-<?php echo e($t->id); ?>" tabindex="-1">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow">
                    ...
                    <form method="POST" action="<?php echo e(route('flash.trips.updateBilling', $t->id)); ?>">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.flash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HF-PC\Downloads\last zip\laravel_app\resources\views/flash/payroll/billing.blade.php ENDPATH**/ ?>