...
<?php $__env->startSection('title', 'Flash Payroll'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid py-4">
        ...
        <div class="ui-hero p-3 p-lg-4 mb-3 mb-lg-4">
            <div
                ...
                <div class="d-flex gap-2">
                    ...
                    <a class="btn btn-outline-secondary" href="<?php echo e(route('flash.payroll.index', [
                            'from' => request('from'),
                            'to' => request('to'),
                        ])); ?>">
                        → Payroll
                    ...
                    <a class="btn btn-outline-secondary" href="<?php echo e(route('flash.payroll.history')); ?>">
                        → History
                    </a>
                        ...
                        <?php $__currentLoopData = $queue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="badge 
                                        <?php echo e($q['status'] === 'Unpaid' ? 'bg-danger' : 'bg-success'); ?>">
                                        <?php echo e($q['status']); ?>
        ...
        <?php if($driversPayroll->isEmpty()): ?>

            <div class="card text-center p-5">
                <h5 class="text-muted mb-2">No Payroll for this date</h5>
                <small class="text-muted">
                    Try selecting a different date range
                </small>
            </div>
        <?php else: ?>
            <?php $__currentLoopData = $driversPayroll; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $d['rows']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td><?php echo e($r['date']); ?></td>
                                            <td><?php echo e($r['driver']); ?></td>
...
<?php echo $__env->make('layouts.flash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HF-PC\Downloads\last zip\laravel_app\resources\views/flash/payroll/dashboard.blade.php ENDPATH**/ ?>