...
<?php $__env->startSection('content'); ?>
                ...
                <div class="toast-body py-2">
                    <ul class="mb-0 ps-3">
                        <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li style="font-size: 0.9rem;"><?php echo e($error); ?></li>
            ...
            <div
                ...
                <div>
                    ...
                    <div class="text-muted small ui-showing">
                        Showing <?php echo e($users->count()); ?> users
                    </div>
                </div>
    ...
    <form method="GET"
    action="<?php echo e(route('owner.users.index')); ?>"
...
<div class="card-body p-3">
    ...
    <div class="grid-span-2">
        ...
        <div class="badge bg-light text-dark w-100 text-center">
            <?php echo e($user->password ? 'Set' : 'Not set'); ?>
    ...
    <form method="POST"
        action="<?php echo e(route('owner.users.destroy', $user->id)); ?>"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex gap-1">
                                            ...
                                            <form method="POST" action="<?php echo e(route('owner.users.destroy', $user->id)); ?>"
                                                onsubmit="return confirm('Delete this user?')">
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="<?php echo e(route('owner.users.update', $user->id)); ?>">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="role" class="form-select">
                                        ...
                                        <option value="owner" <?php echo e($user->role == 'owner' ? 'selected' : ''); ?>>
                                            Owner
                                        </option>
                                        ...
                                        <option value="secretary"
                                            <?php echo e($user->role == 'secretary' ? 'selected' : ''); ?>>
                                            Secretary
                                        </option>
                                        
                                        <option value="it"
                                            <?php echo e($user->role == 'it' ? 'selected' : ''); ?>>
                                            IT
                                        </option>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="<?php echo e(route('owner.users.store')); ?>">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="role" class="form-select" required>
                                    ...
                                    <option value="secretary" <?php if(old('role') === 'secretary'): echo 'selected'; endif; ?>>Secretary</option>
                                    <option value="it" <?php if(old('role') === 'it'): echo 'selected'; endif; ?>>IT</option>
                                </select>
...
<?php echo $__env->make('layouts.owner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HF-PC\Downloads\last zip\laravel_app\resources\views/users/index.blade.php ENDPATH**/ ?>