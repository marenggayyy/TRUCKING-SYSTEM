                                ...
                                <div class="card border mb-3">
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="p-3 border-bottom d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2">
                                            <div>
                                                <div class="fw-bold text-info"><?php echo e($p['name'] ?? 'Unknown Driver'); ?> <span
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php $__empty_3 = true; $__currentLoopData = $p['rows']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_3 = false; ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-end whitespace-nowrap" data-label="Allowance"><?php echo e(number_format($r['allowance'], 2)); ?>
                                ...
                                <div class="card border mb-3">
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="p-3 border-bottom d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2">
                                            ...
                                            <div class="fw-bold text-info"><?php echo e($p['name'] ?? 'Unknown Helper'); ?> <span
...
<?php echo $__env->make('layouts.owner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u649672793/domains/gray-spoonbill-292506.hostingersite.com/laravel_app/resources/views/owner/payroll/history.blade.php ENDPATH**/ ?>