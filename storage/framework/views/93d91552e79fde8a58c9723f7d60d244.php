...
<head>
    ...
    <title><?php echo e(config('app.name', 'Trucking System')); ?></title>
...
<body class="d-flex flex-column">
    ...
    <header class="container py-3 reveal reveal-left">
        <nav class="navbar navbar-expand-lg glass px-3 px-lg-4">
            <a class="navbar-brand text-primary fw-bold d-flex align-items-center gap-2" href="<?php echo e(url('/')); ?>">
                <span class="bg-white text-primary rounded-3 px-2 py-1 fw-bold" style="box-shadow: 0 2px 8px rgba(25,118,210,.2);">🚚</span>
                <span><?php echo e(config('app.name', 'Trucking System')); ?></span>
            </a>
                ...
                <div class="d-flex gap-2">
                    <?php if(Route::has('login')): ?>
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(url('/dashboard')); ?>" class="btn btn-primary btn-sm fw-semibold">
                                <i class="bi bi-speedometer2 me-1"></i> Dashboard
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-primary btn-sm fw-semibold">
                                <i class="bi bi-box-arrow-in-right me-1"></i> Login
                            </a>

                            <!--<?php if(Route::has('register')): ?>-->
                            <!--    <a href="<?php echo e(route('register')); ?>" class="btn btn-primary btn-sm fw-semibold">-->
                        ...
                        <div class="col-lg-7 reveal reveal-left">
                            ...
                            <div class="d-flex gap-2 flex-wrap">
                                <?php if(auth()->guard()->guest()): ?>
                                    <a href="<?php echo e(route('login')); ?>" class="btn btn-primary btn-lg fw-semibold">
                                        <i class="bi bi-box-arrow-in-right me-1"></i> Sign In
                                    </a>
                                    <!--<?php if(Route::has('register')): ?>-->
                                    <!--    <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-primary btn-lg fw-semibold">-->
                                    <!--        <i class="bi bi-person-plus me-1"></i> Create Account-->
                                    <!--    </a>-->
                                    <!--<?php endif; ?>-->
                                <?php else: ?>
                                    <a href="<?php echo e(url('/dashboard')); ?>" class="btn btn-primary btn-lg fw-semibold">
                        ...
                        <div class="col-lg-5 reveal reveal-right">
                            <div class="p-4 rounded-4 bg-white border" style="border-color: rgba(33,150,243,.15); box-shadow: 0 4px 15px rgba(33,150,243,.1);">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <?php if(auth()->guard()->guest()): ?>
                                        <a href="<?php echo e(route('login')); ?>" class="btn btn-primary fw-semibold btn-sm">
                                            Login
                                        </a>
                                    <?php else: ?>
                                        <a href="<?php echo e(url('/dashboard')); ?>" class="btn btn-primary fw-semibold btn-sm">
                                            Dashboard
                                        </a>
                                    <?php endif; ?>
                                </div>
        ...
        <section id="about" class="row justify-content-center mt-4 reveal">
            <div class="col-lg-11">
                <div class="glass p-4 p-md-5" style="background: linear-gradient(135deg, rgba(255,255,255,.95) 0%, rgba(227,242,253,.4) 100%); border: 1px solid rgba(33,150,243,.15);">
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-md-4 text-md-end reveal reveal-right">
                            <?php if(auth()->guard()->guest()): ?>
                                <a href="<?php echo e(route('login')); ?>" class="btn btn-primary fw-semibold">
                                    <i class="bi bi-box-arrow-in-right me-1"></i> Login Now
                                </a>
                            <?php else: ?>
                                <a href="<?php echo e(url('/dashboard')); ?>" class="btn btn-primary fw-semibold">
                ...
                <p class="text-center reveal" style="color: #999; margin-top: 2rem; margin-bottom: 0;">
                    © <?php echo e(date('Y')); ?> <?php echo e(config('app.name', 'Trucking System')); ?> • Built with Laravel & Bootstrap
                </p>
            </div>
        </section>
...
<?php /**PATH /home/u649672793/domains/gray-spoonbill-292506.hostingersite.com/laravel_app/resources/views/welcome.blade.php ENDPATH**/ ?>