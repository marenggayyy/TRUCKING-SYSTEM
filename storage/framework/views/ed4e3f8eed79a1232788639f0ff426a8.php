            ...
            <ul class="navbar-nav ms-auto align-items-center">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="layoutDropdown" role="button"
                        ...
                        Layout: <?php echo e($label); ?>

                    </a>

                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <a class="dropdown-item" href="<?php echo e(route('layout.switch', 'default')); ?>">
                                Chamonix
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="<?php echo e(route('layout.switch', 'flash')); ?>">
                                Flash
                            </a>
                        </li>
                    </ul>
