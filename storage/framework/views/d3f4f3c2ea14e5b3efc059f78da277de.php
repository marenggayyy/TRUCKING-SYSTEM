            ...
            <div class="d-flex flex-column gap-3">
                                ...
                                <div class="card mb-xxl-0 iq-purchase" data-iq-gsap="onStart" data-iq-position-y="50"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                            ...
                                            <a href="<?php echo e(route('flash.trucks.index')); ?>">
                                ...
                                <div class="card mb-xxl-0 iq-purchase" data-iq-gsap="onStart" data-iq-position-y="150"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                            ...
                                            <a href="<?php echo e(route('flash.drivers.index')); ?>">
                                                <svg width="16" height="21" viewBox="0 0 16 21" fill="none"
                                                    ...
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        ...
                                                        stroke-linejoin="round"></path>
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        d="M7.98489 10.5059C10.523 10.5059 12.580１ 8.44782 １２．５８０１　５．９０９７２Ｃ１２．５８０１　３．３７１６３　１０．５２３　１．３１４４８　７．９８４８９　１．３１４４８Ｃ５．４４６７９　１．３１４４８　３．３８８７　３．３７１６３　３．３８８７　５．９０９７２Ｃ３．３８０１３　８．４３９２５　５．４２３９４　１０．４９７３　７．９５２５１　１０．５０５９Ｈ７．９８４８９Ｚ"
                                                        stroke="#7B60E7" stroke-width="₁．₄₂₈₅₇" stroke-linecap="round"
                                                        stroke-linejoin="round"></path>
                                                </svg>
                                            </a>
                                        </div>
                                ...
                                <div class="card iq-purchase" data-iq-gsap="onStart" data-iq-position-y="250"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                            ...
                                            <a href="<?php echo e(route('flash.destinations.index')); ?>">
                                ...
                                <div class="card iq-purchase" data-iq-gsap="onStart" data-iq-position-y="350"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                            ...
                                            <a href="<?php echo e(route('flash.trips.index')); ?>">
                ...
                <div class="card" data-iq-gsap="onStart" data-iq-position-y="70" data-iq-rotate="0"
                    ...
                    <div class="card-header justify-content-between d-flex align-items-center">
                        ...
                        <a href="<?php echo e(route('flash.trips.index')); ?>" class="btn btn-primary btn-sm">View All</a>
                    </div>
                                    ...
                                    <div class="card border h-100">
                                        <div class="card-body">
                                            ...
                                            <p class="mb-1 small">
                                                ...
                                                <?php echo e($trip->destination?->area ?? 'N/A'); ?>
                ...
                <div class="card" data-iq-gsap="onStart" data-iq-position-y="70" data-iq-rotate="0"
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('flash.destinations.index')); ?>" class="btn btn-primary btn-sm">View all</a>
                    </div>
                                ...
                                <div class="col">
                                    <div class="card border h-100">
                                        <div class="card-body">
                                            ...
                                            <h6 class="card-title mb-2"><?php echo e($destination->area ?? 'N/A'); ?></h6>
                                            <p class="mb-1 small"><strong>Code:</strong>
                                                <?php echo e($destination->hub_code ?? '—'); ?></p>
    ...
    ">
                ...
                <div class="card" data-iq-gsap="onStart" data-iq-position-y="70" data-iq-rotate="0"
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('flash.trips.history')); ?>" class="btn btn-primary btn-sm"> View All </a>
                    </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $recentTrips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <span
                                        class="text-muted small"><?php echo e($trip->destination?->area ?? 'No destination'); ?></span>
                                </div>
...
<?php echo $__env->make('layouts.flash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HF-PC\Downloads\last zip\laravel_app\resources\views/flash/dashboard.blade.php ENDPATH**/ ?>