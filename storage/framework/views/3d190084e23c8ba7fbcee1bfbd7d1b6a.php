            ...
            <div class="card ui-card border-0 ui-indicator ui-indicator-primary ui-kpi-card h-80 w-100">
                <div class="card-body text-center ui-kpi-body">
                    ...
                    <div id="creditBalance" class="ui-kpi-number text-primary">
                        PHP<?php echo e(number_format($balance, 2)); ?>
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $expenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr style="display:<?php echo e($i < 10 ? 'table-row' : 'none'); ?>;">
                                            ...
                                            <td class="fw-semibold text-center"><?php echo e($d->format('d')); ?></td>
                                            ...
                                            <td class="text-center d-flex justify-content-center gap-2">
                                                ...
                                                <button class="btn btn-sm btn-primary edit-expense-btn"
                                                    ...
                                                    data-date="<?php echo e($row->date); ?>" data-time="<?php echo e($row->time); ?>"
                                                    data-liters="<?php echo e($row->liters); ?>" data-debit="<?php echo e($row->debit); ?>"
                                                    data-start="<?php echo e($row->start_odometer); ?>"
                                                    data-odometer="<?php echo e($row->odometer); ?>"
                                                    data-receipt="<?php echo e($row->receipt_surrendered); ?>"
                                                    data-remarks="<?php echo e($row->remarks); ?>" data-bs-toggle="modal"
                                                ...
                                                <button class="btn btn-sm btn-outline-danger delete-expense-btn"
                                                    data-id="<?php echo e($row->id); ?>" data-plate="<?php echo e($row->plate_number); ?>"
                                                    data-date="<?php echo e($row->date); ?>" data-liters="<?php echo e($row->liters); ?>"
                                                    data-debit="<?php echo e($row->debit); ?>" data-bs-toggle="modal"
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $credits ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-semibold text-center">
                                                <?php echo e($cd ? $cd->format('d') : '-'); ?>

                                            </td>

                                            <td class="text-end credit-amount">
                                                <?php echo e(number_format($c->amount ?? 0, 2)); ?>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button class="btn btn-sm btn-primary edit-credit-btn"
                                                    ...
                                                    data-amount="<?php echo e($c->amount); ?>">
                                                    <i class="bi bi-pencil"></i>
                                                </button>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $expenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <?php if($e->km_per_liter): ?>
                                        <span class="badge bg-primary">
                                            <?php echo e($e->km_per_liter); ?>
                                ...
                                <select name="plate_number" class="form-select" required>
                                    ...
                                    <?php $__currentLoopData = $trucks ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $truck): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($truck->plate_number); ?>">
                                            <?php echo e($truck->plate_number); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="col-6">
...
<script>
    ...
    <script>
        ...
        document.getElementById('updateExpense').addEventListener('click', function() {
            fetch("<?php echo e(route('owner.payroll.expenses.update')); ?>", {
                    method: "POST",
                    headers: {
        ...
        document.getElementById('confirmDeleteExpense').addEventListener('click', function() {
            ...
            fetch("<?php echo e(url('/owner/payroll/expenses')); ?>/" + id, {
                    method: 'DELETE',
                    headers: {
...
document.addEventListener('change', function (e) {
    ...
    if (e.target.matches('#addExpenseModal select[name="plate_number"]')) {
        ...
        document.getElementById('saveCredit').addEventListener('click', function(e) {
            ...
            fetch('<?php echo e(route('owner.payroll.credits.store')); ?>', {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': token
                    },
        ...
        document.addEventListener('click', function(e) {
            ...
            if (e.target.closest('.delete-credit-btn')) {
                ...
                fetch("<?php echo e(url('/owner/payroll/credits')); ?>/" + id, {
                        method: 'DELETE',
                        headers: {
                            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
                            'Accept': 'application/json'
        ...
        document.getElementById('updateCreditBtn').addEventListener('click', function() {
            ...
            fetch("<?php echo e(route('owner.payroll.credits.update')); ?>", {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
                        "X-CSRF-TOKEN": document.querySelector('meta[name="csrf-token"]').content
...
<?php echo $__env->make('layouts.owner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u649672793/domains/gray-spoonbill-292506.hostingersite.com/laravel_app/resources/views/owner/payroll/expenses.blade.php ENDPATH**/ ?>