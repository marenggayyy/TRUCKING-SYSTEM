...
<div class="row align-items-start g-4">
                            ...
                            <div class="card iq-purchase" data-iq-gsap="onStart" data-iq-position-y="250"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <p class="mb-0 ms-2">Avg: ₱<?php echo e(number_format($destinationsStats['avg_rate'], 2)); ?></p>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        ...
                                        <a href="<?php echo e(route('owner.trips.index')); ?>">
                                            <svg width="15" height="13" viewBox="0 0 15 17" fill="currentcolor"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path d="M7.72461 0.75L7.72461 15.75" stroke="currentcolor"
                                                    stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                                <path d="M1.701 6.7998L7.725 0.749804L13.75 6.7998" stroke="currentcolor"
                                                    stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                            </svg>
                                        </a>
                                    </div>
                        ...
                        <div class="card-group border rounded-1">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1">₱<?php echo e(number_format($todayData['gains'] ?? 0, 2)); ?></h5>
                            ...
                            <div class="col">
                                <div class="card border h-100">
                                    <div class="card-body">
                                        ...
                                        <p class="mb-1 small">
                                            <strong>Destination:</strong> <?php echo e($trip->destination?->store_name ?? 'N/A'); ?>
                            ...
                            <div class="col">
                                <div class="card border h-100">
                                    <div class="card-body">
                                        ...
                                        <p class="mb-1 small"><strong>Code:</strong> <?php echo e($destination->store_code ?? '—'); ?></p>
                                        <p class="mb-2 small"><strong>Area:</strong> <?php echo e($destination->area ?? '—'); ?></p>

                                        <?php if(!empty($destination->remarks)): ?>
                                            <p class="mb-3 small text-muted fst-italic"><?php echo e($destination->remarks); ?></p>
                                        <?php endif; ?>

                                        <div class="d-flex justify-content-between align-items-center pt-2 border-top">
                                            <span class="small text-muted">Rate</span>
                                            <span class="fw-bold text-success">₱<?php echo e(number_format($destination->rate ?? 0, 2)); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="col-lg-4">
        <div class="d-flex flex-column gap-3">
            ...
            <div class="card bg-primary text-center text-white iq-post" data-iq-gsap="onStart" data-iq-position-y="70"
                data-iq-rotate="0" data-iq-trigger="scroll" data-iq-ease="power.out" data-iq-opacity="0">
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-6">
                            ...
                            <h5 class="fw-bolder text-white mb-0">₱<?php echo e(number_format($financialData['gains'] ?? 0, 2)); ?></h5>
                        </div>
                        <div class="col-6">
                            <p class="mb-1 small text-white-50">Expenses</p>
                            <h5 class="fw-bolder text-danger mb-0">₱<?php echo e(number_format($financialData['expenses'] ?? 0, 2)); ?></h5>
                        </div>
                        <div class="col-12">
                            <hr class="border-white-50 my-2">
                            <p class="mb-1 small text-white-50">Net Profit</p>
                            <h4 class="fw-bolder text-success mb-0">₱<?php echo e(number_format($financialData['profit'] ?? 0, 2)); ?></h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card" data-iq-gsap="onStart" data-iq-position-y="70" data-iq-rotate="0"
                ...
                <div class="card-body">
                    <?php $__empty_1 = true; $__currentLoopData = $recentTrips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="d-flex justify-content-between align-items-center flex-wrap py-3 <?php if(!$loop->last): ?> border-bottom <?php endif; ?>">
                            <div class="flex-grow-1">
                                <h6 class="mb-0"><?php echo e($trip->trip_ticket_no ?? 'N/A'); ?></h6>
                                <span class="text-muted small"><?php echo e($trip->destination?->store_name ?? 'No destination'); ?></span>
                            </div>

                            <div class="text-end">
                                <span class="badge bg-<?php if(($trip->status ?? '') === 'Completed'): ?> success <?php elseif(($trip->status ?? '') === 'Dispatched'): ?> warning <?php else: ?> secondary <?php endif; ?>">
            ...
            <div class="card iq-purchase" data-iq-gsap="onStart" data-iq-position-y="70" data-iq-rotate="0" data-iq-trigger="scroll" data-iq-ease="power.out" data-iq-opacity="0">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title fw-bolder mb-0">Recent Audit Trail</h4>
                    <span class="badge bg-primary">Last 10</span>
                </div>
                <div class="card-body">
                    <?php $audits = \App\Models\AuditTrail::with('user')->latest()->limit(10)->get(); ?>
                    <?php $__empty_1 = true; $__currentLoopData = $audits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $audit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="py-3 <?php if(!$loop->last): ?> border-bottom <?php endif; ?>">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <div>
                                    <h6 class="mb-1"><?php echo e($audit->user->name ?? 'System'); ?></h6>
                                ...
                                <?php
                                    $actionColor = match($audit->action) {
                                        'Created trip' => 'bg-success bg-opacity-25 text-success',
                                        'Dispatched trip' => 'bg-primary bg-opacity-25 text-primary',
                                        'Completed trip' => 'bg-info bg-opacity-25 text-info',
                                        'Cancelled trip' => 'bg-warning bg-opacity-25 text-warning',
                                        'Deleted trip' => 'bg-danger bg-opacity-25 text-danger',
                                        default => 'bg-secondary bg-opacity-25 text-secondary',
                                    };
                                ?>
                                <span class="badge <?php echo e($actionColor); ?>">
                                    <?php echo e($audit->action); ?>

                                </span>
                            </div>
                            <p class="mb-0 small text-muted">
                                <?php echo e($audit->description); ?>

                            </p>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <p class="text-muted text-center py-4 mb-0">No audit trail yet</p>
                    <?php endif; ?>
                </div>
            </div>
...
<?php echo $__env->make('layouts.owner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u649672793/domains/gray-spoonbill-292506.hostingersite.com/laravel_app/resources/views/dashboard.blade.php ENDPATH**/ ?>