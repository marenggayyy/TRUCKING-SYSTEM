        ...
        <div class="ui-hero p-3 p-lg-4 mb-3 mb-lg-4">
            ...
            <div
                ...
                <div class="d-flex gap-2">
                    <a href="<?php echo e(route('flash.payroll.dashboard')); ?>" class="btn btn-outline-secondary">
                        ← Dashboard
                    </a>

                    <a href="<?php echo e(route('flash.payroll.index')); ?>" class="btn btn-outline-secondary">
                        ← Payroll
                    </a>
                </div>
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="p-3 border-bottom d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <a href="<?php echo e(route('flash.payroll.pdf', $p['payment_id'])); ?>"
                                                    class="btn btn-sm btn-danger">
                                                    PDF
                                                </a>

                                                <form method="POST"
                                                    action="<?php echo e(route('flash.payroll.delete', $p['payment_id'])); ?>"
                                                ...
                                                <tfoot class="table-light">
                                                    <tr class="text-center fw-semibold">
                                                        ...
                                                        <th>
                                                            ...
                                                            ₱ <?php echo e(number_format($p['advance_amount'] ?? 0, 2)); ?>
...
<?php echo $__env->make('layouts.flash', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HF-PC\Downloads\last zip\laravel_app\resources\views/flash/payroll/history.blade.php ENDPATH**/ ?>