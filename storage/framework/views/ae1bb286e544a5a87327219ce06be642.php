                    ...
                    <div class="d-flex align-items-center gap-2 flex-wrap ms-auto">
                        ...
                        <form class="billing-filter">
                            ...
                            <div class="d-flex align-items-center gap-2 flex-wrap flex-md-nowrap">
                                ...
                                <input type="date" name="check_date" value="<?php echo e(request('check_date')); ?>"
                                ...
                                <a href="<?php echo e(route('owner.payroll.billing')); ?>" class="btn btn-light filter-btn-clear">
                                    Clear
                                </a>
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="small">
                                        ...
                                        <div class="d-flex justify-content-between mb-2">
                                            ...
                                            <span
                                                class="fw-semibold <?php echo e($t->check_release_date ? 'text-primary' : 'text-muted'); ?>">
                                                <?php echo e($t->check_release_date ? \Carbon\Carbon::parse($t->check_release_date)->format('d/m') : 'N/A'); ?>
                                        ...
                                        <div class="d-flex justify-content-between mb-2">
                                            ...
                                            <span class="fw-semibold <?php echo e($t->bank_name ? '' : 'text-muted'); ?>">
                                                <?php echo e($t->bank_name ?? 'N/A'); ?>
                                        ...
                                        <div class="d-flex justify-content-between mb-2">
                                            ...
                                            <span class="fw-semibold <?php echo e($t->check_number ? '' : 'text-muted'); ?>">
                                                <?php echo e($t->check_number ?? 'N/A'); ?>
...
<?php echo e($t->billing_status == 'Billed'
    ...
    : ($t->billing_status == 'Pending'
        ? 'billing-pending'
        : 'billing-unbilled')); ?>">
                                                <?php echo e($t->billing_status ?? 'Unbilled'); ?>

                                            </span>

                                            <span class="trip-status payment">
                                                <?php echo e($t->payment_status ?? 'Unpaid'); ?>
...
<div class="trip-actions mt-0">
            ...
            <div class="modal fade" id="billTripModal-<?php echo e($t->id); ?>" tabindex="-1">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content border-0 shadow">
                        ...
                        <form method="POST" action="<?php echo e(route('owner.trips.complete', $t->id)); ?>">
                            <?php echo csrf_field(); ?>
    ...
    <?php $__currentLoopData = $trips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="modal fade" id="editBillingModal-<?php echo e($t->id); ?>" tabindex="-1">
                    ...
                    <form method="POST" action="<?php echo e(route('owner.trips.updateBilling', $t->id)); ?>">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="check_release_date" value="<?php echo e($t->check_release_date); ?>"
                                    class="form-control">
                            </div>
...
<?php echo $__env->make('layouts.owner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u649672793/domains/gray-spoonbill-292506.hostingersite.com/laravel_app/resources/views/owner/payroll/billing.blade.php ENDPATH**/ ?>