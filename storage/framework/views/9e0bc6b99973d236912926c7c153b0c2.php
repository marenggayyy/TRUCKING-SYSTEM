                                        ...
                                        <tbody>
                                            <?php $__empty_1 = true; $__currentLoopData = $sixWTrucks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $truck): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if($truck->company_number): ?>
                                                            <a href="tel:<?php echo e($truck->company_number); ?>">
                                                                <?php echo e($truck->company_number); ?>
                ...
                <div class="modal-content border-0 shadow">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="<?php echo e(route('owner.trucks.update', $truck->id)); ?>">
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Company Contact No.</label>
                                <input class="form-control" name="company_number" value="<?php echo e($truck->company_number); ?>"
...
<?php echo $__env->make('layouts.owner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HF-PC\Downloads\last zip\laravel_app\resources\views/owner/trucks/index.blade.php ENDPATH**/ ?>